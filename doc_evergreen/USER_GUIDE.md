...
```bash
# 1. Navigate to doc_evergreen directory
cd doc_evergreen
...
**That's it!** Cross-platform, simple, consistent.

**Throughout this guide**, when you see `regen-doc <template>`, use `make regen-doc TEMPLATE=<template>`
